...
function OtherPolicyPage() {
		...
		<div className="row">
			<div className="col-lg-12">
				<Card className={classes.Rootcard}>
					<CardContent>
					<Typography className="h2 pt-8" color="textPrimary">Other Policies</Typography>
					</CardContent>
				</Card>
			</div>
	...
	<div className="row w-98" style={{margin:'1%'}}>
		<div className="col-lg-6 flex sm\:justify-between">	
		<InputLabel htmlFor="my-input" className="text-black pt-8">Upload File</InputLabel>
		<Button
  			variant="contained"
  			component="label"
	...
	<div className="row w-98" style={{margin:'1%'}}>
		<div className="col-lg-12 flex sm\:justify-between">	
			<InputLabel htmlFor="my-input" className="text-black pt-8 w-16">Description</InputLabel>
			<TextareaAutosize 
...
export default OtherPolicyPage;
